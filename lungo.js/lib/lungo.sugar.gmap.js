...
LUNGO.Sugar.GMap = (function(lng, undefined) {
    ...
    var addPolyline = function(flightPlanCoordinates) {
        ...
        _instance_polyline.push(flightPath);

        
        for (var i = 0, len = _instance_polyline.length; i < len; i++) {
            _instance_polyline[i].setMap(_instance);
        }
    ...
    var _cleanPolylines = function() {
       
        for (var i = 0, len = _instance_polyline.length; i < len; i++) {
          _instance_polyline[i].setMap(null);
        }
